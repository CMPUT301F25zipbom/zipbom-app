...
//    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState); // Initializes all the UI elements
        // --- Edit-Specific Logic ---
        populateFields();

        Button updateButton = view.findViewById(R.id.saveEventButton);
        updateButton.setText("Update Event"); // Change button text
...
//    }
    ...
    private void populateFields() {
        ...
        if (originalEventText == null || originalEventId == null) return;
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists() && isAdded()) {
                        ...
                        if (documentSnapshot.contains("posterUrl")) {
                            ...
                            Glide.with(getContext()).load(posterUrl).into(imagePreview);
                            imagePreview.setVisibility(View.VISIBLE);
                        }
                    }
                });
    ...
    /**
     * Implements the abstract method to
     * kotlinx.coroutines.flow.update an existing Firestore document.
     */
    @Override
    protected void processEvent(String eventId, Map<String, Object> eventData, @Nullable String posterUrl) {
        ...
        db.collection("Events").document(eventId)
                .update(eventData) // Use update() for editing
